...
// route pour la recherche de vaches
...
Route::get('/genisses_search', [App\Http\Controllers\GenisseController::class, 'search'])->name('search_genisses');
...
Route::get('/vaches_search', [App\Http\Controllers\VachesController::class, 'search'])->name('search_vaches');


// route pour les taureaux
Route::resource('taureaux', TaureauController::class);
Route::get('/taureaux_search', [App\Http\Controllers\TaureauController::class, 'search'])->name('search_taureaux');

// route pour les veaux
Route::resource('veaux', VeauController::class);
Route::get('/veaux_search', [App\Http\Controllers\VeauController::class, 'search'])->name('search_veaux');

// route pour les velles
Route::resource('velles', VelleController::class);
Route::get('/velles_search', [App\Http\Controllers\VelleController::class, 'search'])->name('search_velles');
...
Route::get('/pesages_search', [App\Http\Controllers\PesageController::class, 'search'])->name('search_pesages');

// route pour les diagnostics
Route::resource('diagnostics', DiagnosticController::class);
Route::get('/diagnostics_search', [App\Http\Controllers\DiagnosticController::class, 'search'])->name('search_diagnostics');
...
/**Bilan production lait et alimentaire et Infos sur les fermiers */
Route::get('/production_lait', [App\Http\Controllers\InfosController::class, 'indexProductLait'])->name('product_lait.index');
Route::get('/voir_production_lait/{id}', [App\Http\Controllers\InfosController::class, 'show'])->name('product_lait.show');
Route::get('/production_lait_search', [App\Http\Controllers\InfosController::class, 'search'])->name('search_production_lait');
