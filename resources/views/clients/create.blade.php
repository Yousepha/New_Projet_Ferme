...
<div class="container">
    <h2 class="alert alert-success text-center color:red">BIENVENUE!! GERER VOS CLIENT ICI</h2>
</div>
<div class="container">
                ...
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="text" class="form-control" name="prenom" id="" placeholder="Prenom" value="{{ old('prenom') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="text" class="form-control" name="nom" id="" placeholder="Nom" value="{{ old('nom') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="email" class="form-control" name="email" id="" placeholder="Email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="text" class="form-control" name="adresse" id="" placeholder="Adresse" value="{{ old('adresse') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="text" class="form-control" name="login" id="" placeholder="login" value="{{ old('login') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="password" class="form-control" name="password" id="" placeholder="mot de passe" value="{{ old('password') }}" required>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="file" name="photo" id="image" class="form-control" onchange="previewFile(this)" value="{{ old('photo') }}" required>
                        ...
                        <button type="submit"  name="add" class="btn btn-info input-lg">Ajouter un client</button>
                </form>
                <!-- Extended default form grid -->
                <!-- </div>
                </div> -->
