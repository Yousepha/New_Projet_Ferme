                    ...
                    <div class="jumbotron text-center">
                        <div align="center">
                            ...
                            <div align="center">
                                ...
                                <h3>Date de l'Achat      : <i>{{ $achat_velle[0]->dateAchatBovin }}</i></h3>
                                <h3>Montant du Velle     : <i>{{ $achat_velle[0]->montantBovin }} Fcfa</i></h3>
                                <!-- <h3>Geniteur      : <i>{{ $data->geniteur }}</i></h3>
                                <h3>Genitrice      : <i>{{ $data->genitrice }}</i></h3> -->
                            </div>
                            <a href="{{ route('achatvelles.index') }}" class="btn bg-dark" style="color:white">Retour</a>
