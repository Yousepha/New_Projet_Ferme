...
<div class="container">
    <h2 class="alert alert-success text-center color:red">ENREGISTREZ VOTRE NOUVEAU ACHAT DE VEAU ICI !</h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achatveaux.store') }}" enctype="multipart/form-data">
                ...
                <form>
                    ...
                    <div class="form-row jumbotron " style="background-color:#8aa;">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="date" id="dateNaiss" class="form-control" name="dateNaissance" id="email" value="{{ old('dateNaissance') }}" placeholder="Date Naissance">
                        ...
                        <div class="form-group col-md-6">
                            <!-- <div class="row"> -->
                                <label for="" class="col-md-6">Race du veau</label>
                                <div class="">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice" class="col-md-6">La date de l'Achat du veau</label>
