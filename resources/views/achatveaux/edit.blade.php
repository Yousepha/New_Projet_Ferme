...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span class="fab fa-laravel"> Gestion des achats de veaux </span></h2>
    <br>
    <h2 class="alert alert-success " > Modifier l'achat du VEAU #{{$data->idBovin}} <span class="fa fa-cow" style="float:right"> {{$data->nom}}  {{ $veau[0]->codeBovin}}</span> </h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achatveaux.update', $data->idBovin) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Extended default form grid -->
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">Le montant du veau</label>
                            <input mdbInput type="number" oninput="this.value = Math.abs(this.value)" class="form-control" name="montantBovin" id="phone" value="{{ $achat_veau[0]->montantBovin }}">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">La date de l'Achat du veau</label>
                            <input mdbInput type="date" class="form-control" name="dateAchatBovin" id="phone" value="{{ $achat_veau[0]->dateAchatBovin }}">
                    ...
                    <!-- Grid row -->
                    <a href="{{ route('achatveaux.index') }}" class="btn btn-warning">Annuler</a>
