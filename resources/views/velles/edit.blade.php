...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span class="fab fa-laravel"> Gestion des Velles </span></h2>
    <br>
    <h2 class="alert alert-success " > Modifier VELLES #{{$data->idBovin}} <span class="fa fa-cow" style="float:right"> {{$data->nom}}  {{ $velle[0]->codeBovin}}</span> </h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('velles.update', $data->idBovin) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="number" oninput="this.value = Math.abs(this.value)" class="form-control" name="prix" id="prix" value="{{ $data->prix }}">
                    ...
                    <!-- Grid row -->
                    <a href="{{ route('velles.index') }}" class="btn btn-warning">Annuler</a>
