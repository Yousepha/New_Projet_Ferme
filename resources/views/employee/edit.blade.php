                                ...
                                <tr >
                                    <td>
                                        <select class="form-control" style="width: 65px" name="num" id="">
                                            <option value="{{ substr($data->telephone, 0, 2)}}">{{ substr($data->telephone, 0, 2)}}</option>
                                            <option value="78"
                                                @if(substr($data->telephone, 0, 2) == 78)
                                                style="display: none"
                                                @endif
                                            >78</option>
                                            <option value="77"
                                                @if(substr($data->telephone, 0, 2) == 77)
                                                style="display: none"
                                                @endif
                                            >77</option>
                                            <option value="76"
                                                @if(substr($data->telephone, 0, 2) == 76)
                                                style="display: none"
                                                @endif
                                            >76</option>
                                            <option value="75"
                                                @if(substr($data->telephone, 0, 2) == 75)
                                                style="display: none"
                                                @endif
                                            >75</option>
                                            <option value="70"
                                                @if(substr($data->telephone, 0, 2) == 70)
                                                style="display: none"
                                                @endif
                                            >70</option>
                                        </select>
                                    ...
                                    <td>
                                        <input style="width: 425px" type="number" oninput="this.value = Math.abs(this.value)" class="form-control" name="telephone" id="gender" value="{{ substr($data->telephone, 2) }}">
