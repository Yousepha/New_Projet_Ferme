...
<div class="container">
    <h2 class="alert alert-success text-center color:red">ENREGISTREZ VOTRE NOUVEAU ACHAT DE GENISSE ICI !</h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achatgenisses.store') }}" enctype="multipart/form-data">
            ...
            @csrf
                ...
                <form>
                    ...
                    <div class="form-row jumbotron " style="background-color:#8aa;">
                        ...
                        <div class="form-group col-md-6">
                            <!-- <div class="row"> -->
                                <label for="" class="col-md-6">Race du Génisse</label>
                                <div class="">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice" class="col-md-6">Le montant du Génisse</label>
                            <input mdbInput type="number" id="genitrice" class="form-control" oninput="this.value = Math.abs(this.value)" name="montantBovin" id="phone" placeholder="montant" value="{{ old('montantBovin') }}">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice" class="">La date de l'Achat du Génisse</label>
                        ...
                        <button type="submit" name="add" class="btn btn-info input-lg">Ajouter un Génisse</button>
                </form>
                <!-- Extended default form grid -->
                <!-- </div>
                </div> -->
