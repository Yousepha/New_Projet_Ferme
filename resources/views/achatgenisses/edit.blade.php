...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span class="fab fa-laravel"> Gestion des achats de genisses </span></h2>
    <br>
    <h2 class="alert alert-success " > Modifier L'ACHAT DU GENISSE #{{$data->idBovin}} <span class="fa fa-cow" style="float:right"> {{$data->nom}}  {{ $genis[0]->codeBovin}}</span> </h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achatgenisses.update', $data->idBovin) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Extended default form grid -->
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">Date IA</label>
                            <input mdbInput type="date" class="form-control" name="dateIA"  value="{{ $genis[0]->dateIA }}">
                        ...
                        <!-- Default input -->
                        {{--<div class="form-group col-md-6">
                            <label for="genitrice">Phase</label>
                            <input mdbInput type="text" class="form-control" name="phase" value="{{ $genis[0]->phase}}" placeholder="phase">
                        </div>--}}
                        ...
                        {{--<div class="form-group col-md-6">
                            ...
                            <div class="">
                                <select name="phase" class="form-control" required>
                                    <option value="{{ $genis[0]->phase}} "

                                        @if($genis[0]->idBovin == $genis[0]->phase)
                                        selected
                                        @endif
                                    ...
                                    @if($genis[0]->phase == "gestant")
                                    <option>non gestant</option>
                                    @endif
                                    @if($genis[0]->phase == "non gestant")
                        ...
                        <!--  -->
                        <div class="form-group col-md-6">
                                <label for="race">Race du Genisse</label>
                                <div class="">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">Le montant du Génisse</label>
                            <input mdbInput type="number" class="form-control" oninput="this.value = Math.abs(this.value)" name="montantBovin" id="phone" value="{{ $achat_genisse[0]->montantBovin }}">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">La date de l'Achat du Génisse</label>
                            <input mdbInput type="date" class="form-control" name="dateAchatBovin" id="phone" value="{{ $achat_genisse[0]->dateAchatBovin }}">
                    ...
                    <!-- Grid row -->
                    <a href="{{ route('achatgenisses.index') }}" class="btn btn-warning">Annuler</a>
                    <button type="submit"  name="add" class="btn btn-info input-lg">Ajouter Génisse</button>
                </form>
                <!-- Extended default form grid -->
                </div>
                </div>
