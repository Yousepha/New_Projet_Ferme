...
<div class="container">
    <h2 class="alert alert-success text-center color:red">ENREGISTREZ VOTRE NOUVEAU ACHAT DE TAUREAU ICI !</h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achattaureaux.store') }}" enctype="multipart/form-data">
            ...
            @csrf
                ...
                <form>
                    ...
                    <div class="form-row jumbotron " style="background-color:#8aa;">
                        ...
                        <div class="form-group col-md-6">
                            <!-- <div class="row"> -->
                                <label for="" class="col-md-6">Race du Taureau</label>
                                <div class="">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice" class="col-md-6">Le montant du Taureau</label>
                            <input mdbInput type="number" id="genitrice" class="form-control" name="montantBovin" oninput="this.value = Math.abs(this.value)" id="phone" placeholder="montant" value="{{ old('montantBovin') }}">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice" class="col-md-6">La date de l'Achat du Taureau</label>
                        ...
                        <button type="submit"  name="add" class="btn btn-info input-lg">Ajouter un Taureau</button>
                </form>
                <!-- Extended default form grid -->
                <!-- </div>
                </div> -->
