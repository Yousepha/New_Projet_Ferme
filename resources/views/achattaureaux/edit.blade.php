...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span class="fab fa-laravel"> Gestion des Achats des taureaux </span></h2>
    <br>
    <h2 class="alert alert-success " > Modifier l'achat du TAUREAU #{{$data->idBovin}} <span class="fa fa-cow" style="float:right"> {{$data->nom}}  {{ $taur[0]->codeBovin}}</span> </h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('achattaureaux.update', $data->idBovin) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Extended default form grid -->
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">Le montant du Taureau</label>
                            <input mdbInput type="number" class="form-control" oninput="this.value = Math.abs(this.value)" name="montantBovin" id="phone" value="{{ $achat_taureau[0]->montantBovin }}">
                        ...
                        <!-- Default input -->
                        <div class="form-group col-md-6">
                            <label for="genitrice">La date de l'Achat du Taureau</label>
                            <input mdbInput type="date" class="form-control" name="dateAchatBovin" id="phone" value="{{ $achat_taureau[0]->dateAchatBovin }}">
                    ...
                    <!-- Grid row -->
                    <a href="{{ route('achattaureaux.index') }}" class="btn btn-warning">Annuler</a>
                    <button type="submit"  name="add" class="btn btn-info input-lg">Ajouter Taureau</button>
                </form>
                <!-- Extended default form grid -->
                </div>
                </div>
