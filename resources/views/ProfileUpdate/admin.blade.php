...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form method="post" action="{{ route('update.profile.admin', $data[0]->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Extended default form grid -->
                <form>
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <table>
                                <tr >
                                    ...
                                    <td>
                                        <input style="width: 425px" type="number" oninput="this.value = Math.abs(this.value)" class="form-control" name="telephone" id="gender" value="{{ substr($data[0]->telephone, 2) }}">
                    ...
                    <!-- Grid row -->
                    <a href="{{ route('admin.home') }}" class="btn btn-warning">Annuler</a>
