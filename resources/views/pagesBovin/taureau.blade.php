      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card mb-4 box-shadow">
            <img src="images/bovin/vendre/taureau1.jpg" class="card-img-top img-fluid" alt="Responsive image">
            <div class="card-body">
              <p class="card-text">nom: Nana  <br>description: race Hollande </p>
              <div class="d-flex justify-content-between align-items-center">
                <span class="price">1.500.000 F</span>
        ...
        <div class="col-md-3">
          <div class="card mb-4 box-shadow">
            <img src="images/bovin/vendre/taureau2.jpg" class="card-img-top img-fluid" alt="Responsive image">
            <div class="card-body">
            <p class="card-text">nom: Nini  <br>description: race Hollande </p>
              <div class="d-flex justify-content-between align-items-center">
                <span class="price">1.200.000 F</span>
        ...
        <div class="col-md-3">
          <div class="card mb-4 box-shadow">
            <img src="images/bovin/vendre/taureau3.jpg" class="card-img-top img-fluid" alt="Responsive image">
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-4 box-shadow">
            <img src="images/bovin/vendre/taureau4.jpg" class="card-img-top img-fluid" alt="Responsive image">
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-4 box-shadow">
            <img src="images/bovin/taureauS1.jpg" class="card-img-top img-fluid" alt="Responsive image">
            <div class="card-body">
