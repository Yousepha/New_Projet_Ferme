...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="">
            <h2 class="alert alert-dark text-center" style="color:red; text:bold">Créer la Maladie</h2>
        </div>
     ...
     <div class="row card shadow">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nomMaladie" class="form-control" placeholder="Nom maladie" value="{{ old('nomMaladie') }}">
