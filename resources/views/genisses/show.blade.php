...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span> INFO du GENISSE</span></h2>
</div>
                ...
                <!-- Form Name -->
                    ...
                    <div class="jumbotron text-center">
                        <div align="center">
                            ...
                            <a href="{{ route('genisses.index') }}" class="btn bg-dark" style="color:white">Retour</a>
