...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span class="fab fa-laravel"> Gestion des Genisses </span></h2>
    <br>
    <h2 class="alert alert-success " > Modifier GENISSE #{{$data->idBovin}} <span class="fa fa-cow" style="float:right"> {{$data->nom}}  {{ $genis[0]->codeBovin}}</span> </h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('genisses.update', $data->idBovin) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
