...
<style>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="">
                <h2 class="alert alert-dark text-center" style="color:red; text:bold">Ajouter la quantité achetée</h2>
            </div>
         ...
         <div class="row card shadow">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="quantite" oninput="this.value = Math.abs(this.value)" class="form-control">
                    <span style="color:red">@error('quantite') {{$message}} @enderror</span>
                
                </div>
            </div>
            {{--value="{{ $data->quantite }}"<div class="col-md-12">
                <div class="form-group">
