...
<div class="container">
    <h2 class="alert alert-dark text-center " style="color:red; text:bold"><span> INFO de la VACHE</span></h2>
</div>
    ...
    <div class="row">
        <div class="col-md-10 ">
            <form class="form-horizontal">
                ...
                <!-- Form Name -->
                    <legend> Information sur la Vache <span class="fa fa"> {{ $data->nom }} </span></legend>
                    ...
                    <div class="jumbotron text-center">
                        <div align="center">
                            ...
                            <a href="{{ route('vaches.index') }}" class="btn bg-dark" style="color:white">Retour</a>
