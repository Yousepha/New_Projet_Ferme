...
<form style="margin-left: 0 auto; width: 600px;">
  {{ csrf_field() }}
    ...
    <div class="form-row col-md-12 center ">
      <label for="inputEmail4">Code Bovin</label>
  ...
  <div class="form-row col-md-12 center">
    <label for="inputEtatDeSante">Etat de santé</label>
    <input type="text" class="form-control" id="inputEtatDeSante" placeholder="Sain">
  </div>
  <div class="form-row col-md-12 center">
  ...
  <div class="form-row col-md-12 center">
    ...
    <div class="form-row col-md-12 center">
      <label for="inputCatégorie">Période</label>
