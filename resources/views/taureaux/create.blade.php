...
<div class="container">
    <h2 class="alert alert-success text-center color:red">ENREGISTREZ VOTRE NOUVEAU TAUREAU ICI</h2>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">

            <form method="post" action="{{ route('taureaux.store') }}" enctype="multipart/form-data">
                ...
                <form>
                    ...
                    <div class="form-row jumbotron " style="background-color:#8aa;">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input mdbInput type="date" id="dateNaiss" class="form-control" name="dateNaissance" id="email" placeholder="Date Naissance" value="{{ old('dateNaissance') }}" value="{{ old('nom') }}">
